...
public class Science_Frag extends Fragment {
    //Views
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.science_frag, container, false);
        return view;
    }
    ...
    private void initPostModel() {
        ...
        postViewModel.getNews("us", "science");
    ...
    private void initViews() {
        recyclerView = view.findViewById(R.id.science_RV);
        progressBar = view.findViewById(R.id.PB_Science);
    }
